...
const NewsArticle = ({ article }) => {
  ...
  const { data, refetch, isFetching } = useGetOneNewsQuery({id: router.query.id as string})
  ...
  return (
    <div className='mainContainer'>
      <div className={styles.newsArticle}>
        <div className={styles.newsArticleHead}
          style={{
        ...
        <div className={styles.newsArticleBody}>
          ...
          {/* Share buttons */}
            <div className={styles.shareButtons}>
              ...
              <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className={styles.shareButton}>
                WhatsApp
              </a>
