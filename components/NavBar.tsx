  ...
  return (
    <>
      <Box bg="transparent" position="relative" >
        <Flex h={16} px="7%" alignItems={'center'} justifyContent={'space-between'} w="100%">
           <Box>
        ...
        <Flex h={16} px="7%" alignItems={'center'} justifyContent={'space-between'} position="absolute" w="100%">
          <IconButton
            size={'sm'}
