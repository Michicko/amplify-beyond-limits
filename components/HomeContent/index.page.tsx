...
const Home = () => {
  ...
  const {data, isLoading } = useGetHomeDataQuery()
    ...
    return (
    !data && !data?.data || isLoading ? <h4>Loading.......</h4>:<div>
      <Slider/>
    <section className="match-updates">
        <div className="previous-match">
            ...
            <div className="card">
            <MatchCard
                date={moment(data.data.last_played_match.match.date).format("MMM DD, YYYY, hh:mm")}
                ...
                score={data.data.last_played_match.home_goals+" - "+data.data.last_played_match.away_goals}
        ...
        <div className="next-match standing-match">
            ...
            <div className="card">
            <MatchCard
                date={moment(data.data.next_match.match.date).format("MMM DD, YYYY, hh:mm")}
